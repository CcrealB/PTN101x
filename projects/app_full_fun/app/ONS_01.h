...
//	#define SPDIF_GPIO		GPIO14	// GPIO11, GPIO12, GPIO14
	...
	#define	KeyDnRVal	{0,1,2,3,3.9,5.6,6.8,9.1,12}	//設置拉低電阻
	//-----------------------------------------
	...
	#define	Key2DnRVal	{0,1,2,3,3.9,5.6,6.8,9.1,12}	//設置拉低電阻

	//---------------------------------------------------
	#define	KbonNUM	2
	#define	SarADC_CH2	SARADC_CH_GPIO23
	#define	SarADC_CH3	SARADC_CH_GPIO22
