...
//	#define PromptToneMusicMute
	...
	//-----------------------------------------
	#define ADC_KEY_NUM		9		//
	#define SarADC_CH0	SARADC_CH_GPIO20
	#define AdcV	2850	// mv	 拉高電壓
	#define VRang	 100	// 按鍵電壓(mv)上下範圍值
	#define KeyUpR	 10		// k	拉高電阻
	#define	KeyDnRVal	{0,1,2.2,3,3.9,5.6,6.8,9.1,12}	//設置拉低電阻
	//-----------------------------------------
	#define ADC_KEY2_NUM	9		//
	#define SarADC_CH1	SARADC_CH_GPIO21
	#define AdcV2	2850	// mv	 拉高電壓
	#define VRang2	 100	// 按鍵電壓(mv)上下範圍值
	#define Key2UpR	 10		// k	拉高電阻
	#define	Key2DnRVal	{0,1,2.2,3,3.9,5.6,6.8,9.1,12}	//設置拉低電阻

	//---------------------------------------------------
	#define	SarADC_CH2	SARADC_CH_GPIO22	// Music Vol
	#define	SarADC_CH3	SARADC_CH_GPIO32	//
	#define	SarADC_CH4	SARADC_CH_GPIO31
	#define	SarADC_CH5	SARADC_CH_GPIO23
