...
#if defined(KT56) && (defined(PTN1011_DEMO_V2p2)||defined(PTN1012_DEMO_V2p2))	//|| defined(A40_Effect)
...
typedef struct
{
	...
	uint8_t	LOCK;
	uint8_t	PAIR;
} KT_SYS_INF_TAB;	// Len 8bYE
#define    	Freq_Top	510000
#define    	Freq_Step	500
#define    	S_CHA		1
#define    	S_CHB		20
KT_SYS_INF_TAB	KtSysInf={1, 1, S_CHA, S_CHB, 0, 0, 0, 0};
*/
