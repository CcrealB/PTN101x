...
result_t avdtp_session_disconnect(avdtp_session_h ss, int32_t linger);
...
result_t avdtp_stream_disconnect(avdtp_stream_h st, int32_t linger);
...
result_t avdtpStreamCapClear(avdtp_stream_h st);
#endif
