...
result_t avctp_lower_disconnect(avctp_lower_h lower, int32_t linger);

result_t avctp_lower_send(avctp_lower_h lower, BOOL ipid, uint16_t pid,
...
void avctp_upper_input(avctp_upper_h upper, BOOL ipid, avctp_pid_t pid,
    avctp_tid_t tid, avctp_msg_type_t type, struct mbuf *m);
