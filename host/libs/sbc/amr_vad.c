                        ...
                        )
{
  ...
  /* 3000 - 4000 Hz*/
  level[8] = level_calculation(tmp_buf, &st->sub_level[8], VAD_FRAME_LEN/4-8,
                               VAD_FRAME_LEN/4, 4, 1, 15);
  move16 ();
  /* 2500 - 3000 Hz*/  
  level[7] = level_calculation(tmp_buf, &st->sub_level[7], VAD_FRAME_LEN/8-4,
                               VAD_FRAME_LEN/8, 8, 7, 16);
  move16 ();
  /* 2000 - 2500 Hz*/
  level[6] = level_calculation(tmp_buf, &st->sub_level[6], VAD_FRAME_LEN/8-4,
                               VAD_FRAME_LEN/8, 8, 3, 16);
  move16 ();
  /* 1500 - 2000 Hz*/
  level[5] = level_calculation(tmp_buf, &st->sub_level[5], VAD_FRAME_LEN/8-4,
                               VAD_FRAME_LEN/8, 8, 2, 16);
  move16 ();
  /* 1000 - 1500 Hz*/
  level[4] = level_calculation(tmp_buf, &st->sub_level[4], VAD_FRAME_LEN/8-4,
                               VAD_FRAME_LEN/8, 8, 6, 16);
  move16 ();
  /* 750 - 1000 Hz*/
  level[3] = level_calculation(tmp_buf, &st->sub_level[3], VAD_FRAME_LEN/16-2,
                               VAD_FRAME_LEN/16, 16, 4, 16);
  move16 ();
  /* 500 - 750 Hz*/
  level[2] = level_calculation(tmp_buf, &st->sub_level[2], VAD_FRAME_LEN/16-2,
                               VAD_FRAME_LEN/16, 16, 12, 16);
  move16 ();
  /* 250 - 500 Hz*/
  level[1] = level_calculation(tmp_buf, &st->sub_level[1], VAD_FRAME_LEN/16-2,
                               VAD_FRAME_LEN/16, 16, 8, 16);
  move16 ();
  /* 0 - 250 Hz*/
  level[0] = level_calculation(tmp_buf, &st->sub_level[0], VAD_FRAME_LEN/16-2,
                               VAD_FRAME_LEN/16, 16, 0, 16);
  move16 ();
}
         ...
         )
{
   ...
   st->corr_hp_fast = L_round(L_tmp);           /* Q15 */    move16();   
...
int vad1_init (vadState1 **state)
{
    ...
    *state = NULL;
    ...
    /* allocate memory */
    if ((s = (vadState1 *) jmalloc(sizeof(vadState1),M_ZERO)) == NULL){
