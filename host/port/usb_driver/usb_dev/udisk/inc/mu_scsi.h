...
/*BEKEN DEFINED SCSI CMD*/
#define MGC_SCSI_BEKEN_DATA_OUT 	        0xE0
#define MGC_SCSI_BEKEN_DATA_IN	 	        0xE1
#define MGC_SCSI_BEKEN_CMD			        0xE2
#define MGC_SCSI_BEKEN_SPP_CONN_CMD         0xE3
#define MGC_SCSI_BEKEN_GET_SPP_CONN_STATUS  0xE4
#define MGC_SCSI_BEKEN_SIMPLE_MODE_TEST     0xE5
#define MGC_SCSI_BEKEN_STANDARD_MODE_TEST   0xE6
#define MGC_SCIS_BEKEN_ADVANCED_MODE_TEST   0xE7

#define MGC_SCSI_BEKEN_FILTER_WRITE			0xE8

//BK_Writer 扩展命令
#define MGC_SCSI_BEKEN_WRITER				0x46
/* Mode pages */
