...
os_bus_resource_h os_bus_alloc_resource(os_bus_h bus,
    os_resource_type_t type, int32_t id);
...
os_bus_h os_bus_get_transceiver(os_bus_h bus, int32_t id);
int32_t os_bus_get_controller_id(os_bus_h bus);

#define ENABLE_VBUS 1
#define DISABLE_VBUS 0
void os_set_vbus_state(BOOL enable);
