...
result_t bt_a2dp_sink_set_configuration_rsp(bt_a2dp_sink_session_h session_h,
    bt_a2dp_sink_input_method_t method, int32_t local_ep_id, int32_t remote_ep_id);
...
result_t bt_a2dp_sink_get_default_aac(bt_a2dp_mpeg_aac_t *aac);
#endif

#ifdef A2DP_VENDOR_DECODE
result_t bt_a2dp_sink_get_default_vendor(bt_a2dp_vendor_t *ladc);
#endif
