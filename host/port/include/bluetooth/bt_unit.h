...
result_t bt_unit_authentication_enable(bt_unit_h unit_h, BOOL enable);
result_t bt_unit_encryption_enable(bt_unit_h unit_h, BOOL enable);
...
result_t bt_unit_simple_pairing_debug_enable(bt_unit_h unit_h, BOOL enable);
#endif
#endif
