...
#define a2dp_codec_ie_length(codec_type) (\
    ...
    (codec_type) == A2DP_CODEC_NON_A2DP ? sizeof(bt_a2dp_vendor_t) :\
    0)
...
#define SBC_SUBBANDS_4_MASK     (1 << 3) /* 4 subbands */
#define SBC_SUBBANDS_8_MASK     (1 << 2) /* 8 subbands */
