...
DRAM_CODE BOOL BTtimer_Is_Expired(t_timer ptimer);
...
BOOL BTtimer_Piconet_if_Expired(t_timer ptimer);
...
RAM_CODE t_timer BTtimer_Set_Timer_On_Timing_Equation( 
    t_clock ref_time_ticks,             /* -i   Time to check equations at  */
    BOOL init_proc_2,                /* -i   Initialisation 1/2 if 0/1   */
    t_slots T_proc_slots,               /* -i   Procedure Interval in Slots */
 ...
 ************************************************************************/
RAM_CODE BOOL BTtimer_Is_Timing_Equation_Satisfied(                        
    t_clock ref_time_ticks,             /* -i   Time to check equations at  */
    BOOL init_proc,                  /* -i   Initialisation 1/2 if 0/1   */
    t_slots T_proc_slots,               /* -i   Procedure Interval in Slots */
    t_slots D_proc_slots                /* -i   Procedure Offset in Slots   */
    );
 ...
 ************************************************************************/
DRAM_CODE BOOL BTtimer_Is_Expired_For_Time(
    t_timer timer,                      /* -i   Timer to Adjust             */
    t_clock ref_time_ticks              /* -i   Time to check equations at  */
    );    
 ...
 *  
 ************************************************************************/
BOOL BTtimer_Is_Expired_For_Time_Instant(
    t_timer timer,                      /* -i   Timer to Adjust             */
    t_clock ref_time_ticks              /* -i   Time to check equations at  */
    );    
