...
__INLINE__ uint16_t HCIparam_Get_Uint16(t_p_pdu);
__INLINE__ uint32_t HCIparam_Get_Uint24(t_p_pdu);
__INLINE__ uint16_t HCIparam_Get_HCI_Opcode(t_p_pdu);
...
__INLINE__ uint16_t HCIparam_Get_Packet_Types(t_p_pdu);
__INLINE__ t_error HCIparam_Get_Reason(t_p_pdu);
__INLINE__ t_role HCIparam_Get_Role(t_p_pdu);
__INLINE__ uint8_t HCIparam_Get_Length(t_p_pdu);
__INLINE__ uint8_t HCIparam_Get_Num_Responses(t_p_pdu);
__INLINE__ uint8_t HCIparam_Get_Inquiry_Length(t_p_pdu);
...
__INLINE__ uint8_t HCIparam_Get_Allow_Role_Switch(t_p_pdu);
