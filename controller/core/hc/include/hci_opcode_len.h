...
CONST uint8_t link_control_command_len[MAX_HC_LINK_CONTROL_OPCODE+1] = {
...
CONST uint8_t link_policy_command_len[MAX_HC_LINK_POLICY_OPCODE+1] = {
...
CONST uint8_t hc_bb_command_len[MAX_HC_BB_COMMAND_OPCODE+1] = {
...
CONST uint8_t information_command_len[MAX_HC_INFO_COMMAND_OPCODE+1] = {
        0x00,  /* Invalid Opcode                            */
...
CONST uint8_t le_command_len[MAX_HC_LE_COMMAND_OPCODE+1] = {
        0x00,  /* Invalid Opcode                            */
...
CONST uint8_t le_smp_command_len[MAX_LE_SMP_COMMAND_OPCODE+1] = {
        0x00,  /* Invalid Opcode                                  */
...
CONST uint8_t status_command_len[MAX_HC_STATUS_COMMAND_OPCODE+1] = { 
        0x00,  /* Invalid Opcode                            */
...
CONST uint8_t test_command_len[MAX_HC_TEST_COMMAND_OPCODE+1] = {
        0x00,  /*  Invalid Opcode                           */
