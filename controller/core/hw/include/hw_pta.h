...
BOOL HWpta_Initialise(void);
void HWpta_Return_To_Standby(void);
BOOL HWpta_Set_Bt_Req_Lead_Time(uint16_t lead_time);

BOOL HWpta_Control_Enabled(BOOL enabled);
BOOL HWpta_Test_Control_Enabled(BOOL enabled);

void HWpta_Tx_Access_Request(BOOL priority, BOOL freq_overlap, t_role role);
void HWpta_Rx_Access_Request(BOOL priority, BOOL freq_overlap, t_role role);
...
void HWpta_Generic_BT_Access_Mode(BOOL enabled);
void HWpta_Combine_BT_RX_REQ(BOOL enabled);

void HWpta_LE_Access_Request(BOOL priority, BOOL freq_overlap, t_RadioMode rf_mode);
void HWpta_LE_Access_Complete(void);

void HWpta_Extended_Access_Request(BOOL priority, BOOL freq_overlap,
    		  				uint16_t number_of_slots);
...
__INLINE__ void HW_set_pta_mode_enable(const uint32_t mode) { mSetHWEntry(JAL_PTA_MODE_ENABLE);}
__INLINE__ void HW_set_pta_grant_test_enable(const uint32_t mode) { mSetHWEntry(JAL_PTA_GRANT_TEST_ENABLE);}
...
__INLINE__ void HW_set_GIO_HIGH_BT_TX_REQ(const uint32_t value)  {mSetHWEntry(HAB_GIO_HIGH_12, value); }
__INLINE__ void HW_set_GIO_HIGH_BT_TX_PRIORITY(const uint32_t value)  {mSetHWEntry(HAB_GIO_HIGH_13, value); }
__INLINE__ void HW_set_GIO_HIGH_TX_ACCESS(const uint32_t value)  {mSetHWEntry(HAB_GIO_HIGH_14, value); 
                  /*mSetHWEntry(HAB_GIO_HIGH_19, value);*/ } /* shadow combine */
__INLINE__ void HW_set_GIO_HIGH_RX_ACCESS(const uint32_t value)  {mSetHWEntry(HAB_GIO_HIGH_15, value); 
                   mSetHWEntry(HAB_GIO_HIGH_20, value); } /* shadow combine */
__INLINE__ void HW_set_GIO_HIGH_BT_TX_FREQ_OVERLAP(const uint32_t value)  {mSetHWEntry(HAB_GIO_HIGH_16, value); }
__INLINE__ void HW_set_GIO_HIGH_PTA_TX_GRANT_TEST(const uint32_t value)  {mSetHWEntry(HAB_GIO_HIGH_17, value); }
__INLINE__ void HW_set_GIO_HIGH_PTA_RX_GRANT_TEST(const uint32_t value)  {mSetHWEntry(HAB_GIO_HIGH_19, value); }
__INLINE__ void HW_set_GIO_HIGH_BT_EPTA_REQ(const uint32_t value)  {mSetHWEntry(HAB_GIO_HIGH_18, value); }
__INLINE__ void HW_set_GIO_HIGH_BT_RX_REQ(const uint32_t value) {mSetHWEntry(HAB_GIO_HIGH_21, value); }
__INLINE__ void HW_set_GIO_HIGH_BT_RX_PRIORITY(const uint32_t value)  {mSetHWEntry(HAB_GIO_HIGH_22, value); }
__INLINE__ void HW_set_GIO_HIGH_BT_RX_FREQ_OVERLAP(const uint32_t value)  {mSetHWEntry(HAB_GIO_HIGH_23, value); }

__INLINE__ void HWpta_Set_GIOs_Hi_Early(const uint16_t mask)  {mSetHWEntry(PTA_GIO_HIGH_EARLY_EN, mask); }
__INLINE__ void HWpta_Set_GIOs_Hi_Late(const uint16_t mask)  {mSetHWEntry(PTA_GIO_HIGH_LATE_EN, mask); }
__INLINE__ void HWpta_Set_GIOs_Lo_Early(const uint16_t mask)  {mSetHWEntry(PTA_GIO_LOW_EARLY_EN, mask); }
__INLINE__ void HWpta_Set_GIOs_Lo_Late(const uint16_t mask)  {mSetHWEntry(PTA_GIO_LOW_LATE_EN, mask); }

#else /* declare prototypes */

void HW_set_GIO_HIGH_BT_TX_REQ(const uint32_t value);
void HW_set_GIO_HIGH_BT_TX_PRIORITY(const uint32_t value);
void HW_set_GIO_HIGH_TX_ACCESS(const uint32_t value);
void HW_set_GIO_HIGH_RX_ACCESS(const uint32_t value);
void HW_set_GIO_HIGH_BT_TX_FREQ_OVERLAP(const uint32_t value);
void HW_set_GIO_HIGH_PTA_TX_GRANT_TEST(const uint32_t value);
void HW_set_GIO_HIGH_PTA_RX_GRANT_TEST(const uint32_t value);
void HW_set_GIO_HIGH_BT_EPTA_REQ(const uint32_t value);
void HW_set_GIO_HIGH_BT_RX_REQ(const uint32_t value);
void HW_set_GIO_HIGH_BT_RX_PRIORITY(const uint32_t value);
void HW_set_GIO_HIGH_BT_RX_FREQ_OVERLAP(const uint32_t value);

void HWpta_Set_GIOs_Hi_Early(const uint16_t mask);
void HWpta_Set_GIOs_Hi_Late(const uint16_t mask);
void HWpta_Set_GIOs_Lo_Early(const uint16_t mask);
void HWpta_Set_GIOs_Lo_Late(const uint16_t mask);
...
#if defined(__USE_INLINES__) || defined(_PARTHUS_HW_PTA_IMPL_)
__INLINE__ void HW_set_GIO_LOW_BT_TX_REQ(const uint32_t value)  {mSetHWEntry(HAB_GIO_LOW_12, value); }
__INLINE__ void HW_set_GIO_LOW_BT_TX_PRIORITY(const uint32_t value)  {mSetHWEntry(HAB_GIO_LOW_13, value); }
__INLINE__ void HW_set_GIO_LOW_TX_ACCESS(const uint32_t value)  {mSetHWEntry(HAB_GIO_LOW_14, value); 
                 /*mSetHWEntry(HAB_GIO_LOW_19, value);*/ } /* shadow combine */
__INLINE__ void HW_set_GIO_LOW_RX_ACCESS(const uint32_t value)  {mSetHWEntry(HAB_GIO_LOW_15, value); 
                   mSetHWEntry(HAB_GIO_LOW_20, value); } /* shadow combine */
__INLINE__ void HW_set_GIO_LOW_BT_TX_FREQ_OVERLAP(const uint32_t value)  {mSetHWEntry(HAB_GIO_LOW_16, value); }
__INLINE__ void HW_set_GIO_LOW_PTA_TX_GRANT_TEST(const uint32_t value)  {mSetHWEntry(HAB_GIO_LOW_17, value); }
__INLINE__ void HW_set_GIO_LOW_PTA_RX_GRANT_TEST(const uint32_t value)  {mSetHWEntry(HAB_GIO_LOW_19, value); }
__INLINE__ void HW_set_GIO_LOW_BT_EPTA_REQ(const uint32_t value)  {mSetHWEntry(HAB_GIO_LOW_18, value); }
__INLINE__ void HW_set_GIO_LOW_BT_RX_REQ(const uint32_t value) {mSetHWEntry(HAB_GIO_LOW_21, value); }
__INLINE__ void HW_set_GIO_LOW_BT_RX_PRIORITY(const uint32_t value)  {mSetHWEntry(HAB_GIO_LOW_22, value); }
__INLINE__ void HW_set_GIO_LOW_BT_RX_FREQ_OVERLAP(const uint32_t value)  {mSetHWEntry(HAB_GIO_LOW_23, value); }
#else /* declare prototypes */
void HW_set_GIO_LOW_BT_TX_REQ(const uint32_t value);
void HW_set_GIO_LOW_BT_TX_PRIORITY(const uint32_t value);
void HW_set_GIO_LOW_TX_ACCESS(const uint32_t value);
void HW_set_GIO_LOW_RX_ACCESS(const uint32_t value);
void HW_set_GIO_LOW_BT_TX_FREQ_OVERLAP(const uint32_t value);
void HW_set_GIO_LOW_PTA_TX_GRANT_TEST(const uint32_t value);
void HW_set_GIO_LOW_PTA_RX_GRANT_TEST(const uint32_t value);
void HW_set_GIO_LOW_BT_EPTA_REQ(const uint32_t value);
void HW_set_GIO_LOW_BT_RX_REQ(const uint32_t value);
void HW_set_GIO_LOW_BT_RX_PRIORITY(const uint32_t value);
void HW_set_GIO_LOW_BT_RX_FREQ_OVERLAP(const uint32_t value);
#endif
