 ...
 */
     ...
     */
        ...
        #define mGetHWEntry32(Field)                                        \
            (( (uint32_t) ((*((u_intHW volatile *)(Field##_ADDR)))           \
                    /* & 0xFFFF */) ) |                                     \
            (( (uint32_t)((*((u_intHW volatile *)(Field##_ADDR + 2)))        \
                    /* & 0xFFFF */) ) << 16))

        #define mSetHWEntry32(Field, Source)                                \
            { uint32_t Value = (uint32_t) Source; /* May be an expression */  \
         ...
         */
        #define mGetHWEntry32(Field) \
            (((uint32_t) ((SWAP_ENDIAN(*((u_intHW volatile *)(Field##_ADDR + device_addr)))) & 0xFFFF)) | \
            ((uint32_t) ((SWAP_ENDIAN(*((u_intHW volatile *)(Field##_ADDR + device_addr + 2)))) << 16)))
