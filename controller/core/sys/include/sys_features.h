...
#define PRH_BS_CFG_LOCAL_NAME        "ptn101dm-partner"
#endif
...
#define LMP_VERSION_BT_5_1		10 /*Bluetooth Core Specification 5.1*/
#define LMP_VERSION_BT_5_2		11 /*Bluetooth Core Specification 5.2*/

#define PRH_BS_CFG_LMP_VERSION        LMP_VERSION_BT_5_2
...
#define PRH_BS_CFG_BYTE_5   mSYSfeatures_Select_Min_Default_Max(0x00, 0x00, 0x3D, 0x3D, 0x00, 0x00)
...
#define PRH_BS_CFG_LE_FIX_PLL_ISSUE 0
 ...
 */
#define LMP_RSSI_DEVICE_ASSESSMENT          1
...
#define TESTMODE_NON_SIGNAL_R2P_SUPPORTED       1
#define LONG_TERM_NO_PKT_RETURN_TO_PICONET      1
#define LONG_TERM_NO_PKT_TIMEOUT                400
#endif

/*
*   These macro is same as host MACRO define:
*   CONFIG_HFP17_MSBC_SUPPORTED
*   CONFIG_A2DP_PLAYING_SET_AG_FLOW
*   CONFIG_CRTL_POWER_IN_BT_SNIFF_MODE
*/
#define HOST_HFP17_MSBC_SUPPORTED               1
#define HOST_A2DP_PLAYING_FLOW_CTRL             1
#define HOST_SNIFF_MODE_SUPPORTED               1
