...
__INLINE__ void SYSatomic_Increment_u_int8(uint8_t *);
__INLINE__ void SYSatomic_Decrement_u_int8(uint8_t *);

__INLINE__ void SYSatomic_Increment_u_int16(uint16_t *);
__INLINE__ void SYSatomic_Decrement_u_int16(uint16_t *);
