...
#endif
    g_sys_config.feature_set[0] |= 0x20;  // Role Switch Feature //TWS
    return g_sys_config.feature_set;
}

__INLINE__ uint8_t* SYSconfig_Get_LMP_Req_Features_Ref(void)
{
    extern t_SYS_Config g_sys_config;
#if (CONFIG_CTRL_BQB_TEST_SUPPORT == 1)	
	SYShal_config_set_EDR3_feature();
#endif
    SYShal_config_Set_Role_Switch_feature();
    return g_sys_config.feature_set;
}
 ...
 *****************************************************************************/
__INLINE__ void SYSconfig_Set_LMP_Features(const uint8_t lmp_features_array[8])
{
    extern t_SYS_Config g_sys_config;
    uint8_t *p_lmp_features = g_sys_config.feature_set;
 ...
 *****************************************************************************/
__INLINE__ BOOL SYSconfig_Is_Feature_Supported(uint32_t lmp_feature_id)
{
    extern t_SYS_Config g_sys_config;
 ...
 *                 Byte 0    Defines the bit position in identified byte
 *****************************************************************************/
__INLINE__ BOOL SYSconfig_Is_Command_Supported(uint32_t hci_command_id)
{
    extern t_SYS_Config g_sys_config;
 ...
 *                 Byte 0    Defines the bit position in identified byte
 *****************************************************************************/
__INLINE__ void SYSconfig_Enable_Feature(uint32_t lmp_feature_id)
{
    extern t_SYS_Config g_sys_config;
    g_sys_config.feature_set[lmp_feature_id>>8] |= (uint8_t) _SYS_GET_CHAR_8_BITS(lmp_feature_id);
}
 ...
 *                 Byte 0    Defines the bit position in identified byte
 *****************************************************************************/
__INLINE__ void SYSconfig_Disable_Feature(uint32_t lmp_feature_id)
{
    extern t_SYS_Config g_sys_config;
    g_sys_config.feature_set[lmp_feature_id>>8] &= (uint8_t) _SYS_GET_CHAR_8_BITS(~lmp_feature_id);
}
 ...
 *****************************************************************************/
__INLINE__ void SYSconfig_Set_Ext_Features(const uint8_t ext_features_array[8])
{
    extern t_SYS_Config g_sys_config;
    uint8_t *p_ext_features = g_sys_config.feature_set+8;
 ...
 *****************************************************************************/
__INLINE__ void SYSconfig_Set_Unit_Key(uint8_t* new_key)
{
    uint8_t i;
    extern t_SYS_Config g_sys_config;
    for(i = 0; i < 16; i++)
...
__INLINE__ void SYSconfig_Set_Erroneous_Data_Reporting(uint8_t erroneous_dr)
{
    extern t_SYS_Config g_sys_config;
...
__INLINE__ void SYSconfig_Set_AGC_Mode(uint8_t agc_mode)
{
    extern t_SYS_Config g_sys_config;
