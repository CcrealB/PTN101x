...
#define TCI_NON_SIGNAL_TEST_CONTROL_COMMAND           0x008c + ST_G
...
//    BEKEN_DISABLE_ESCO                          =0x3A,    
    ...
    BEKEN_ENTRY_BLE_DUT_MODE                    =0XB0,
    BEKEN_LED_EQ_BUTTON							=0xB2,
    BEKEN_SET_AEC_PARA							=0xB3,
    LOOP_MODE_CMD                               =0XCC,
    BEKEN_TEMP1_CMD                             =0XD4,
    BEKEN_TEMP2_CMD                             =0XD5,
    BEKEN_TEMP3_CMD                             =0XD6,
    BEKEN_CMD_VUSB_DLP                      	=0xC1,
    BEKEN_CMD_VUSB_DLP_PRINTF                   =0xC2,
    BEKEN_SDIO_TEST								=0XC3,
    BEKEN_USB_DEVICE_TEST 					    =0XC4,
    
    BEKEN_CMD_APPEND_TLV                        =0xD3,

    BEKEN_CMD_LPBG_CALI                         =0xD0,
    BEKEN_CMD_WRITE_CALI                        =0xD1,

#ifdef CONFIG_PRODUCT_TEST_INF
    BEKEN_RSSI_CMD                              =0XE0,
    BEKEN_TEST_SPP_AUDIOCONN                    =0XE1,
    BEKEN_TEST_SPP_AUDIODISCON                  =0XE2,
#else
    BEKEN_RSSI_CMD                              =0XE0,
#endif
...
#endif
#if CHARGER_VERIFY
    BEKEN_CMD_CHARGE_VERIFY_V4P25               =0XE1,
    BEKEN_CMD_CHARGE_VERIFY_V4P15               =0XE2,
    BEKEN_CMD_CHARGE_CALIBRATION                =0XE3,
    BEKEN_CMD_CHARGE_WRITE_RERSULT              =0XE4,
#endif
    BEKEN_TRANSPARENT_HCI_CMD                   =0xF0,
    PHONE_BOOK_PULL_BOOK                        =0xF1,
    PHONE_BOOK_PULL_vCARD                       =0xF2,
    PHONE_BOOK_PULL_vCARDList                   =0xF3,
    PHONE_BOOK_PULL_SetPath                     =0xF4,
    PHONE_BOOK_CALL_LAST_vCard_Number           =0xF5,
    PHONE_BOOK_PULL_PHONE_NUM_vCard             =0xF6,
    BEKEN_ENTRY_FCC_TESTMODE					=0xFC,
    BEKEN_ENTRY_NON_SIG_TESTMODE		   	    =0xFD,
