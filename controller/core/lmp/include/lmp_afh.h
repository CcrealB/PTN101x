...
void LMafh_Set_AFH_Control_Byte(uint8_t afh_channel_control);
...
void LMPafh_Request_Classification_Reporting_All_Slaves(uint8_t mode);
void LMPafh_Request_Classification_Reporting(t_lmp_link *p_link, uint8_t mode);
void LMafh_LMP_Channel_Classification_Req_Ack(t_deviceIndex device_index);
BOOL LMafh_Is_LMP_Channel_Classification_Req_Pending(uint8_t mode);


void LMafh_Start_Classification_Reporting(t_lmp_link *p_link);
void LMafh_Stop_Classification_Reporting(t_lmp_link *p_link);
BOOL LMafh_Is_Classification_Reporting(t_lmp_link *p_link);
...
uint8_t LMafh_LM_Read_AFH_Channel_Assessment_Mode(void);
...
void LMafh_Set_Request_Channel_Classification(uint8_t piconet_index);
