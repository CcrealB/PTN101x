...
void LMkeydb_LM_Read_Stored_Link_Key(t_bd_addr* p_bd_addr, uint8_t read_all_flag,
                                     t_cmd_complete_event* p_cmd_complete_info);
void LMkeydb_LM_Write_Stored_Link_Key(t_bd_addr* p_bd_addr, uint8_t* link_key,
                                      t_cmd_complete_event* p_cmd_complete_info);
void LMkeydb_LM_Delete_Stored_Link_Key(t_bd_addr* p_bd_addr, uint8_t delete_all_flag,
                                       t_cmd_complete_event* p_cmd_complete_info);
uint8_t LMkeydb_Read_Max_Keys(void);
uint8_t LMkeydb_Read_Num_Keys(void);
uint8_t* LMkeydb_Read_Link_Key(t_bd_addr* p_bd_addr);
