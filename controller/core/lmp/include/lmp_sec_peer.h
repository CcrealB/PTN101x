...
t_error LMsec_peer_LMP_Not_Accepted(t_lmp_link* p_link, uint16_t opcode,
    t_error reason);
...
void LMsec_peer_Send_LMP_Accepted(t_lmp_link* p_link, uint8_t opcode, 
    uint8_t tid_role);
void LMsec_peer_Send_LMP_Message(t_lmp_link *p_link, uint8_t opcode, 
    uint8_t tid_role, void *param);
void LMsec_peer_Send_LMP_Not_Accepted(t_lmp_link* p_link, uint8_t opcode, 
    uint8_t tid_role, t_error reason);
