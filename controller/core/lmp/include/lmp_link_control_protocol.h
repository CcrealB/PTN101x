...
t_error LMlc_LP_Inc_Power(t_lmp_link* p_link, uint8_t power_units);
t_error LMlc_LP_Dec_Power(t_lmp_link* p_link, uint8_t power_units);

t_error LMlc_LM_Inc_Peer_Power(t_lmp_link* p_link, uint8_t power_units);
t_error LMlc_LM_Dec_Peer_Power(t_lmp_link* p_link, uint8_t power_units);
t_error LMlc_LM_Read_Transmit_Power_Level(t_lmp_link* p_link, uint8_t power_type,
...
t_error LMlc_LMP_Not_Accepted(t_lmp_link* p_link, uint16_t opcode, t_error reason);
