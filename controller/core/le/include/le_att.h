...
{
	uint8_t current_procedure;
	uint8_t sub_procedure;
#if (PRH_BS_CFG_SYS_LE_ATT_INCLUDED==1)//merge CEVA 0517
	uint16_t MTU_LEN;//merge CEVA 0517
	uint8_t UUID_len;//merge CEVA 0517
	uint8_t pending_ATT_opcode;//merge CEVA 0517
	uint8_t protocol;//merge CEVA 0517
	uint16_t start_handle;
	uint16_t end_handle;
	uint16_t primary_service_UUID;
	uint16_t characteristic_Handle;//merge CEVA 0517
	uint8_t  value[PRH_BS_CFG_SYS_LE_CLIENT_GATT_MAX_LONG_WRITE];//merge CEVA 0517
	uint16_t value_offset;//merge CEVA 0517
	uint16_t value_len;//merge CEVA 0517
	uint8_t prepared_write_pending;//merge CEVA 0517
	uint8_t last_prepare_write_error;//merge CEVA 0517
	uint8_t UUID[16];//merge CEVA 0517
	uint16_t characteristic_16bit_UUID;//merge CEVA 0517
	uint16_t connection_handle;//merge CEVA 0517
#endif
} t_ATT_config;
/*
...
{
	uint8_t   event_opcode;//merge CEVA 0517
	uint16_t  handle;//merge CEVA 0517
	uint8_t   status;//merge CEVA 0517
	uint8_t   payload_length;//merge CEVA 0517
	uint8_t*  payload;//merge CEVA 0517
	uint16_t  att_handle;//merge CEVA 0517
	uint8_t   att_len;//merge CEVA 0517
} t_gatt_event_params;//merge CEVA 0517

typedef struct t_gatt_command_complete_params//merge CEVA 0517
{
	uint8_t   operation_id;//merge CEVA 0517
	uint16_t  handle;//merge CEVA 0517
	uint8_t   status;//merge CEVA 0517
	uint16_t  mtu_len;//merge CEVA 0517
...
typedef struct t_Att_pdu_params {
	...
	//merge CEVA 0517 remove uint8_t num_handle_uuid_pairs;//merge CEVA 0517
	...
	uint8_t num_handles;
	uint16_t handle[5];//merge CEVA 0517

	uint16_t attribute_type16;

	uint8_t length;
    
    t_attribute attribute;//merge CEVA 0517
	//merge CEVA 0517 remove uint8_t num_attributes;//merge CEVA 0517
	...
	uint8_t* p_UUID;//merge CEVA 0517
	uint8_t  UUID_len;//merge CEVA 0517
...
{
	uint8_t len;//merge CEVA 0517
	uint16_t UUID_val;//merge CEVA 0517
	uint8_t* p_UUID;//merge CEVA 0517
...
t_error GATT_Discover_Primary_Service(uint16_t connection_handle,uint8_t UUID_type, uint8_t* p_UUID, uint8_t protocol_id);//merge CEVA 0517
t_error GATT_Relationship_Discovery(uint16_t connection_handle, uint16_t start_handle, uint16_t end_handle );//merge CEVA 0517
t_error GATT_Characteristic_Discovery(uint16_t connection_handle, uint8_t uuid_type, uint8_t* p_UUID, uint16_t start_handle, uint16_t end_handle, uint8_t protocol_id);//merge CEVA 0517
t_GATT_error GATT_Characteristic_Descriptor_Discovery(uint16_t connection_handle,uint16_t start_handle, uint16_t end_handle );//merge CEVA 0517
t_error GATT_Characteristic_Value_Read(uint16_t connection_handle, uint8_t control, uint8_t offset, uint8_t* p_UUID,//merge CEVA 0517
		uint16_t start_handle, uint16_t end_handle, uint8_t protocol_id );//merge CEVA 0517
//t_error GATT_Characteristic_Value_Read_Multiple(uint16_t connection_handle,uint16_t handle1,uint16_t handle2,uint16_t handle3,uint16_t handle4,uint16_t handle5);
t_error GATT_Characteristic_Value_Read_Multiple(uint16_t connection_handle,uint8_t* p_handle);//merge CEVA 0517
t_error GATT_Characteristic_Value_Write( uint16_t connection_handle, uint8_t write_instruct, uint8_t offset, uint16_t characteristic_value_handle, uint16_t characteristic_len, uint8_t* p_characteristic, uint8_t protocol_id );//merge CEVA 0517
t_error GATT_Client_Charactaristic_Descriptor_Write(uint16_t connection_handle,  uint16_t char_desc_value_handle, uint16_t char_desc_value_len, uint8_t* p_value );//merge CEVA 0517
t_error GATT_Client_Execute_Write(uint16_t handle,uint8_t flags);//merge CEVA 0517
t_error GATT_Client_Charactaristic_Descriptor_Read(uint16_t connection_handle /*,uint8_t long_val*/, uint16_t char_desc_handle);//merge CEVA 0517

uint8_t GATT_Event(uint8_t event_opcode, uint16_t handle, uint16_t payload_len, uint8_t attrib_len, uint8_t* p_pdu,uint8_t status);//merge CEVA 0517
uint8_t GATT_Command_Complete_Event(uint16_t handle,uint8_t operation_id,uint8_t status);//merge CEVA 0517

void Gatt_Set_MTU_Size(uint16_t mtu_size);//merge CEVA 0517

uint8_t GATT_Check_Is_Link_Encrypted(void);//merge CEVA 0517
void GATT_Check_GATT_Timers(void);//merge CEVA 0517
uint8_t GATT_Exchange_MTU(uint16_t handle);//merge CEVA 0517
uint16_t GATT_Get_Active_Handle(void);//merge CEVA 0517
void GATT_Register_GAP_Callbacks(void* event_funct_ptr, void* command_complete_funct_ptr);//merge CEVA 0517

void LEatt_Decode_PDU(t_LE_Connection* p_connection,uint16_t mtu_length,uint8_t* p_pdu);//merge CEVA 0517
void LEatt_Encode_PDU(uint16_t connection_handle, uint8_t opcode,t_Att_pdu_params* p_pdu_params);//merge CEVA 0517
