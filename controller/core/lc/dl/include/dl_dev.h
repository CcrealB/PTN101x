...
BOOL DL_Is_eSCO_LT_Addr_Shared(t_am_addr lt_addr);
...
uint8_t DL_LT_ADDR_to_LT_INDEX_Mapping(t_devicelink* p_device_link, t_lt_addr lt_addr);
...
__INLINE__ void   DL_Set_Role_Peer(t_devicelink *p_device_link, uint32_t role);
...
__INLINE__ void  DL_Set_AM_Addr(t_devicelink* p_device_link, uint32_t am_addr);
__INLINE__ t_am_addr DL_Get_Am_Addr(const t_devicelink* p_device_link);

__INLINE__ void  DL_Set_Piconet_Index(t_devicelink* p_device_link, uint32_t piconet_index);
__INLINE__ t_am_addr DL_Get_Piconet_Index(const t_devicelink* p_device_link);
__INLINE__ BOOL DL_Max_Piconets(void);
...
__INLINE__ uint16_t DL_Get_Local_Slot_Offset(const t_devicelink* p_device_link);
__INLINE__ void DL_Set_Peer_Slot_Offset(t_devicelink* p_device_link, uint16_t offset);
...
__INLINE__ BOOL DL_Decode_Valid_LT_address(t_devicelink* p_device_link, uint8_t lt_addr);
__INLINE__ void DL_Set_Active_Tx_LT(t_devicelink* p_device_link, uint8_t active_lt);
__INLINE__ void DL_Set_Active_Rx_LT(t_devicelink* p_device_link, uint8_t active_lt);
__INLINE__ uint8_t DL_Get_Active_Rx_LT(t_devicelink* p_device_link);
__INLINE__ uint8_t DL_Get_Active_Tx_LT(t_devicelink* p_device_link);
__INLINE__ void DL_Set_LT_Address(t_devicelink* pDevLink, uint8_t lt_addr);
__INLINE__ uint8_t DL_Get_LT_Address(const t_devicelink* pDevLink);
...
__INLINE__ void DL_Set_eSCO_LT_Address(t_devicelink* p_device_link, uint8_t esco_lt_index, uint8_t lt_addr);

__INLINE__ uint8_t DL_Get_eSCO_LT_Address(const t_devicelink* p_device_link);

__INLINE__ void DL_Set_eSCO_Tx_Length(t_devicelink* p_device_link, uint16_t tx_length);

__INLINE__ uint16_t DL_Get_eSCO_Tx_Length(const t_devicelink* p_device_link);

__INLINE__ void DL_Set_eSCO_Rx_Length(t_devicelink* p_device_link, uint16_t rx_length);

__INLINE__ uint16_t DL_Get_eSCO_Rx_Length(const t_devicelink* p_device_link);

__INLINE__ void DL_Set_eSCO_Tx_Data(t_devicelink* p_device_link, uint8_t* data);

__INLINE__ uint8_t* DL_Get_eSCO_Tx_Data(const t_devicelink* p_device_link);

/*
 * Channel control arqn, flow, seqn and force transmit (POLL received)
 */

__INLINE__ uint32_t DL_Get_Tx_LT_Previous_Arqn(const t_devicelink* pDevLink);

__INLINE__ void DL_Set_Rx_LT_Previous_Arqn(t_devicelink* pDevLink, uint32_t arqn);



__INLINE__ void DL_Toggle_Rx_LT_Seqn(t_devicelink* pDevLink);

__INLINE__ void DL_Set_Tx_LT_Seqn(t_devicelink* pDevLink, uint32_t seqn);

__INLINE__ uint32_t DL_Get_Tx_LT_Seqn(const t_devicelink* pDevLink);
...
__INLINE__ uint8_t DL_Is_Tx_Seqn_Active(t_devicelink* pDevLink);
#endif

__INLINE__ uint32_t DL_Get_Remote_Rxbuf_Full(const t_devicelink* p_device_link);
__INLINE__ void  DL_Set_Remote_Rxbuf_Full(t_devicelink* p_device_link, uint32_t status);

__INLINE__ uint32_t DL_Get_Local_Rxbuf_Full(const t_devicelink* p_device_link);
__INLINE__ void  DL_Set_Local_Rxbuf_Full(t_devicelink* p_device_link, uint32_t status);


__INLINE__ void DL_Set_Rx_LT_Expected_Seqn(t_devicelink* pDevLink, uint32_t seqn);

__INLINE__ uint32_t DL_Get_Rx_LT_Expected_Seqn(const t_devicelink* pDevLink);
...
__INLINE__ void  DL_Set_Rx_Expected_Broadcast_Seqn(t_devicelink* p_device_link, uint32_t seqn);
__INLINE__ void  DL_Toggle_Rx_Expected_Broadcast_Seqn(t_devicelink* p_device_link);
__INLINE__ uint32_t DL_Get_Rx_Expected_Broadcast_Seqn(const t_devicelink* p_device_link);

__INLINE__ uint32_t DL_Get_Tx_Ack_Pending(const t_devicelink* p_device_link);
__INLINE__ void  DL_Set_Tx_Ack_Pending(t_devicelink* p_device_link, uint32_t ackPending);


__INLINE__ uint32_t DL_Get_Tx_LT_Tx_Ack_Pending(const t_devicelink* pDevLink);
__INLINE__ uint32_t DL_Get_Rx_LT_Tx_Ack_Pending(const t_devicelink* pDevLink);

__INLINE__ void DL_Set_Tx_LT_Tx_Ack_Pending(t_devicelink* pDevLink, uint8_t tx_ack_pending);
__INLINE__ void DL_Set_Rx_LT_Tx_Ack_Pending(t_devicelink* pDevLink, uint32_t ack_pending);
...
__INLINE__ uint8_t DL_Get_Power_Level(const t_devicelink* p_device_link);
__INLINE__ void   DL_Set_Power_Level(t_devicelink* p_device_link, uint8_t power_units);

#if (PRH_BS_CFG_SYS_ENHANCED_POWER_CONTROL_SUPPORTED==1)
uint8_t DL_Get_EPC_Power_Level(const t_devicelink* p_device_link, t_packet packetType);
__INLINE__ void DL_Enable_EPC(t_devicelink* pDevLink);
__INLINE__ BOOL DL_Is_EPC_Enabled(t_devicelink* pDevLink);
BOOL DL_Read_Current_Transmit_Power_Level(t_deviceIndex device_index, t_requested_transmit_power_level requested_transmit_power_level, 
											                           int8_t *transmit_power_levels);

BOOL DL_Power_Control_Req(t_deviceIndex device_index, t_packetTypes allowed_pkt_types, 
...
__INLINE__ void
    DL_Set_Local_Slot_Offset(t_devicelink* p_device_link, uint16_t offset);
__INLINE__ uint16_t
    DL_Get_Peer_Slot_Offset(const t_devicelink* p_device_link);
__INLINE__ void
    DL_Set_Peer_Slot_Offset(t_devicelink* p_device_link, uint16_t offset);

__INLINE__ uint32_t
    DL_Get_Piconet_Clock_Last_Access(const t_devicelink* p_device_link);
__INLINE__ void
    DL_Set_Piconet_Clock_Last_Access(t_devicelink* p_device_link, uint32_t clock);

__INLINE__ uint8_t
    DL_Get_Clock_Jitter(const t_devicelink* p_device_link);
__INLINE__ void
    DL_Set_Clock_Jitter(t_devicelink* p_device_link, uint8_t jitter);

__INLINE__ uint8_t
    DL_Get_Clock_Drift(const t_devicelink* p_device_link);
__INLINE__ void
    DL_Set_Clock_Drift(t_devicelink* p_device_link, uint8_t drift);
...
__INLINE__ uint8_t*  DL_Get_Tx_Qpdu(const t_devicelink* p_device_link);
__INLINE__ uint8_t DL_Get_Tx_Opcode_Pending(const t_devicelink* pDevLink);
...
__INLINE__ void DL_Set_Tx_Qpdu(t_devicelink* p_device_link, uint8_t* buffer);
...
__INLINE__ uint8_t DL_Get_Active_SCO_Index(const t_devicelink* p_device_link);
__INLINE__ void DL_Set_Active_SCO_Index(t_devicelink* p_device_link, uint8_t index);
...
__INLINE__ void
    DL_Set_Encryption_Key_Ref(t_devicelink* p_device_link, uint8_t *p_encryption_key);
__INLINE__ uint8_t* DL_Get_Encryption_Key_Ref(const t_devicelink* p_device_link);

__INLINE__ void
    DL_Set_Encryption_Key_Length(t_devicelink* p_device_link, uint8_t encryption_key_length);

__INLINE__ uint8_t DL_Get_Encryption_Key_Length(const t_devicelink* p_device_link);
...
__INLINE__ uint32_t DL_Parked_Device_Exists(void);

#endif /* (PRH_BS_CFG_SYS_LMP_PARK_SUPPORTED==1) */

#if (PRH_BS_CFG_SYS_LMP_RSSI_SUPPORTED==1)
__INLINE__ int8_t DL_Get_RSSI(t_devicelink* p_device_link);
__INLINE__ int8_t DL_Get_RSSI_For_Last_Packet_Received(t_devicelink* p_device_link);
__INLINE__ int8_t DL_Get_1Mb_RSSI(t_devicelink* p_device_link);
__INLINE__ int8_t DL_Get_2Mb_RSSI(t_devicelink* p_device_link);
__INLINE__ int8_t DL_Get_3Mb_RSSI(t_devicelink* p_device_link);
void DL_Update_RSSI_Average(t_devicelink* p_device_link, int8_t rssi);
#endif
...
__INLINE__ uint32_t DL_Get_Rx_eSCO_To_Good(const t_devicelink* p_device_link);
__INLINE__ void  DL_Set_Rx_eSCO_To_Good(t_devicelink* p_device_link, uint32_t good);
#endif
__INLINE__ void  DL_Init_Rx_eSCO_Pending(t_devicelink* p_device_link,t_packet packet);
__INLINE__ uint32_t DL_Get_Rx_eSCO_Pending(const t_devicelink* p_device_link);
__INLINE__ void  DL_Set_Rx_eSCO_Pending(t_devicelink* p_device_link, uint32_t rxPending);
RAM_CODE uint8_t DL_Map_LT_ADDR_to_LT_Handle(t_devicelink* p_device_link, t_lt_addr lt_addr);
uint8_t DL_Allocate_eSCO_Link(t_devicelink* p_device_link);
__INLINE__ void DL_Free_eSCO_Link(t_devicelink* p_device_link, uint8_t esco_lt_index);
#endif
...
__INLINE__ BOOL DL_Is_EDR_Enabled(const t_devicelink* pDevLink);
__INLINE__ void DL_Set_PTT_ACL(t_devicelink* pDevLink, BOOL  ptt);
__INLINE__ BOOL DL_Get_PTT_ACL(const t_devicelink* pDevLink);
__INLINE__ void DL_Set_PTT_ESCO(t_devicelink* pDevLink, BOOL ptt);
__INLINE__ BOOL DL_Get_PTT_ESCO(const t_devicelink* pDevLink);
#endif
...
__INLINE__ uint8_t DL_Get_Rx_SYNC_Erroneous_Data_Status(t_devicelink* pDevLink);
__INLINE__ void DL_Set_Rx_SYNC_Erroneous_Data_Status(t_devicelink* pDevLink,uint8_t status);
