...
RAM_CODE BOOL LSLCslot_Local_Piconet_Request(void);

DRAM_CODE BOOL LSLCslot_Write_BT_Clk_Avoid_Race(t_clock const * p_bt_clk);
...
void LSLCslot_eSCO_tx_3slot_packet_expected(BOOL expected);
void LSLCslot_eSCO_rx_3slot_packet_expected(BOOL expected);
#endif

#if (BUILD_TYPE==UNIT_TEST_BUILD)
BOOL LSLCslot_Get_eSCO_tx_3slot_packet_expected(void);
BOOL LSLCslot_Get_eSCO_rx_3slot_packet_expected(void);
#endif
