...
void LSLCirq_Disable_All_Intr_Except(uint32_t except_tim_intr_mask);
...
void LSLCirq_Disable_All_Tim_Intr_Except(uint32_t except_tim_intr_mask);
...
typedef struct
{
    uint32_t tim0_count, tim1_count, tim2_count, tim3_count,
        pka_count,
