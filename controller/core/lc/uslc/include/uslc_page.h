...
t_error USLCpage_Request(t_deviceIndex device_index, BOOL allow_fhs,
                          uint16_t train_repetitions, t_slots page_timeout);
void USLCpage_Cancel(void);
void USLCpage_Initialise(void);
void USLCpage_Page(BOOL look_ahead_to_next_frame);
...
uint8_t USLCpage_Is_Page_Suspended(void);
BOOL USLCpage_expired(void);
#endif
