...
t_error USLCparkSlave_Access_Window_Request(t_slots t_access, uint32_t m_access, 
                 uint32_t n_acc_slot, uint8_t n_poll, t_deviceIndex device_index, t_ar_addr ar_addr);
...
void USLCparkSlave_Park(BOOL /*dummy*/);
