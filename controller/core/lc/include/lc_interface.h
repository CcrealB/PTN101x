 ...
 ************************************************************************/
uint16_t LC_Get_Max_Sleep_Time_Slots(
 ...
 */
uint8_t LC_Read_Power(t_deviceIndex device_index);
BOOL LC_Incr_Power(t_deviceIndex device_index, uint8_t power_units);
BOOL LC_Decr_Power(t_deviceIndex device_index, uint8_t power_units);
 ...
 */
uint32_t LC_Read_Clock_Offset(t_deviceIndex device_index);
uint16_t LC_Read_Local_Slot_Offset(t_deviceIndex device_index);
void LC_Write_Remote_Slot_Offset(t_deviceIndex device_index, uint16_t slot_offset);
uint8_t LC_Read_Local_Device_Jitter(void);
uint8_t LC_Read_Local_Device_Drift(void);
void LC_Write_Device_Jitter(t_deviceIndex device_index, uint8_t jitter);
void LC_Write_Device_Drift(t_deviceIndex device_index, uint8_t drift);
...
t_error LC_Create_Connection(const t_bd_addr *p_bd_addr, t_clock bt_clk_offset,
              t_deviceIndex device_index,  uint16_t train_reps, t_slots pageTO);
t_error LC_Page_Cancel(void);
t_error LC_Page_Resume(t_slots slots);
BOOL LC_Page_expired(void);
#else
...
t_error LC_Inquiry_Request(t_lap inquiry_lap, t_slots window, uint16_t train_reps);
 ...
 * LC Hold Procedures
 ************************************************************************/
t_error LC_Hold_Return_Request(t_deviceIndex device_index, uint16_t search_window);
...
t_error LC_Access_Window_Request(uint32_t n_acc_slot, t_slots t_access, uint32_t m_access, 
                 uint8_t n_poll, t_deviceIndex device_index, t_ar_addr ar_addr);
 ...
 * SCO Codec Control
 */ 
BOOL LC_Is_Valid_SCO_Conversion(uint16_t voice_setting);
uint8_t LC_Get_Hardware_SCO_CFG(uint16_t voice_setting);
void LC_Enable_Codec(void);
void LC_Disable_Codec(void);
void LC_Increase_Volume(void);
void LC_Decrease_Volume(void);
uint8_t LC_Get_Vci_Clk_Sel(void);
uint8_t LC_Get_Vci_Clk_Sel_Map(void);
 ...
 */
        ...
        #define LC_Get_Next_Slave_Tx_Activity(dev_index) (BOOL)(\
            (lc_call_back_list[LC_GET_NEXT_SLAVE_TX_ACTIVITY] != 0) ? \
                ((BOOL(*)(t_deviceIndex))(lc_call_back_list[LC_GET_NEXT_SLAVE_TX_ACTIVITY]))(dev_index) : 0 )
        #define LC_Get_Next_Slave_Rx_Activity(dev_index) (BOOL)(\
            (lc_call_back_list[LC_GET_NEXT_SLAVE_RX_ACTIVITY] != 0) ? \
                ((BOOL(*)(t_deviceIndex))(lc_call_back_list[LC_GET_NEXT_SLAVE_RX_ACTIVITY]))(dev_index) : 0 )
        ...
        #define LC_Get_Next_Slave_Tx_Activity(dev_index) ((BOOL(*)(t_deviceIndex))lc_call_back_list[LC_GET_NEXT_SLAVE_TX_ACTIVITY])(dev_index)
        #define LC_Get_Next_Slave_Rx_Activity(dev_index) ((BOOL(*)(t_deviceIndex))lc_call_back_list[LC_GET_NEXT_SLAVE_RX_ACTIVITY])(dev_index)
...
void LC_Set_SCO_Repeater_Bit(uint32_t value);
uint32_t LC_Get_SCO_Repeater_Bit(void);
#endif
 ...
 * maps directly to int8_t DL_Get_RSSI(t_devicelink* p_device_link);
 ************************************************************************/
...
#define LC_PAGE_SUSPEND_TIMER    0x18
#define LC_INQUIRY_SUSPEND_TIMER 0x20
#define LC_PAGE_RESUME_TIMER     0x16
/************************************************************************
...
RAM_CODE t_clock       LC_Get_Piconet_Clock_Ex(t_deviceIndex device_index, BOOL in_context);
void          LC_Set_Active_Piconet(t_deviceIndex device_index, BOOL change_piconet);
t_deviceIndex LC_Get_Active_Piconet(void);

BOOL LC_Is_Sleep_Possible(t_clock *next_instant);

/*
 * EDR related
 */
#if (PRH_BS_CFG_SYS_LMP_EDR_SUPPORTED==1)
void LC_Set_PTT_ACL(t_deviceIndex device_index, BOOL ptt_acl);
BOOL LC_Get_PTT_ACL(t_deviceIndex device_index);
void LC_Set_PTT_ESCO(t_deviceIndex device_index, BOOL ptt_esco);
BOOL LC_Get_PTT_ESCO(t_deviceIndex device_index);
#else
...
uint8_t LC_Get_Local_EIR(t_cmd_complete_event* p_event);
uint8_t* LC_Get_Local_EIR_Payload(void);
uint8_t LC_Get_Local_EIR_Length(void);
t_packet LC_Get_Local_EIR_Packet_Type(void);
uint8_t LC_Set_Local_EIR(uint8_t fec_required, uint8_t* p_eir);
#endif
...
#endif
#endif
void LC_Set_Inquiry_Tx_Power(int8_t power_level);
int8_t LC_Get_Inquiry_Response_Tx_Power(void);

uint8_t LC_Is_Inquiry_Suspended(void);
uint8_t LC_Get_Inq_State(void);
uint8_t LC_Is_Page_Suspended(void);
#endif
