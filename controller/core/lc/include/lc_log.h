...
{
    uint16_t procedure_request;
    uint16_t procedure_accept;
    uint16_t procedure_start;
    uint16_t procedure_cancel;
    uint16_t pkts_recv_state1;
    uint16_t pkts_recv_state2;
