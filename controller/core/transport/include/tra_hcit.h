...
void TRAhcit_Generic_Commit_Rx_Buf(uint8_t tra_source);
void TRAhcit_Generic_Acknowledge_Complete_Tx(uint8_t tra_source, uint32_t length);
...
void TRAhcit_Rx_Char(uint8_t ch);
