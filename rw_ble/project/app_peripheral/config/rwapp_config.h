...
//#define CFG_APP_SEC
//#define CFG_APP_HID
//#define CFG_APP_HOGPRH
#define CFG_APP_FEE0S
//#define CFG_APP_FCC0S
//#define CFG_APP_ELECTRIC
#define CFG_APP_FFF0S
//#define CFG_APP_ANCS
...
#if defined(CFG_APP_FFF0S)
#define BLE_APP_FFF0S           1
#else // defined(BLE_APP_FFF0S)
#define BLE_APP_FFF0S           0
#endif // defined(BLE_APP_FFF0S)
...
/// User define Application
#if defined(CFG_APP_ELECTRIC)
#define BLE_APP_ELECTRIC           1
#else 
#define BLE_APP_ELECTRIC           0
#endif // defined(CFG_APP_ELECTRIC)
...
/// HOGPBH Application
#if defined(CFG_APP_HOGPRH)
#define BLE_APP_HOGPRH       1
#else // defined(BLE_APP_HOGPRH)
#define BLE_APP_HOGPRH       0
#endif // defined(BLE_APP_HOGPRH)
