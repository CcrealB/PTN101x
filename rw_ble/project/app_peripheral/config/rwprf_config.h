...
#define CFG_PRF_FFF0S
//#define CFG_PRF_HOGPRH
//#define CFG_PRF_ELECTRIC
...
/// FFF0S Profile Monitor Role
#if defined(CFG_PRF_FFF0S)
...
/// ELECTRIC Profile Monitor Role
#if defined(CFG_PRF_ELECTRIC)
#define BLE_ELECTRIC_SERVER        1
#else
#define BLE_ELECTRIC_SERVER        0
#endif // defined(CFG_PRF_FCC0S)
