 ...
 * </pre>
 */
#define EM_BT_EXTAB_ADDR   (0x01110000 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_LE_EXTAB_ADDR   (0x01110000 + EM_ET_OFFSET)
...
__INLINE void em_le_extab_pack(int elt_idx, uint8_t schprio1, uint8_t spa, uint8_t aenps, uint8_t rsvd, uint8_t iso, uint8_t status, uint8_t mode)
{
    ASSERT_ERR((((uint16_t)schprio1 << 11) & ~((uint16_t)0x0000F800)) == 0);
    ASSERT_ERR((((uint16_t)spa << 10) & ~((uint16_t)0x00000400)) == 0);
    ...
    ASSERT_ERR((((uint16_t)status << 3) & ~((uint16_t)0x00000038)) == 0);
    ASSERT_ERR((((uint16_t)mode << 0) & ~((uint16_t)0x00000007)) == 0);
    EM_WR(EM_LE_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE,  ((uint16_t)schprio1 << 11) | ((uint16_t)spa << 10) | ((uint16_t)aenps << 8) | ((uint16_t)rsvd << 7) | ((uint16_t)iso << 6) | ((uint16_t)status << 3) | ((uint16_t)mode << 0));
}

__INLINE void em_le_extab_unpack(int elt_idx, uint8_t* schprio1, uint8_t* spa, uint8_t* aenps, uint8_t* rsvd, uint8_t* iso, uint8_t* status, uint8_t* mode)
{
 ...
 * </pre>
 */
#define EM_RAWSTP0_ADDR   (0x01110002 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_RAWSTP1_ADDR   (0x01110004 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_FINESTP_ADDR   (0x01110006 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_CSPTR_ADDR   (0x01110008 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_PRIOBW_ADDR   (0x0111000A + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_PRIOLVL_ADDR   (0x0111000C + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_PTI_VXCHAN_ADDR   (0x0111000E + EM_ET_OFFSET)
