...
#define L2C_MIN_LE_MTU_SEC_CON              (65)
...
{
    /// Pairing Request
    L2C_CODE_PAIRING_REQ                  = 0x01,
    /// Pairing Response
    L2C_CODE_PAIRING_RESP                 = 0x02,
    /// Pairing Confirm
    L2C_CODE_PAIRING_CFM                  = 0x03,
    /// Pairing Random
    L2C_CODE_PAIRING_RANDOM               = 0x04,
    /// Pairing Failed
    L2C_CODE_PAIRING_FAILED               = 0x05,
    /// Encryption Information
    L2C_CODE_ENCRYPTION_INF               = 0x06,
    /// Master Identification
    L2C_CODE_MASTER_ID                    = 0x07,
    /// Identity Information
    L2C_CODE_IDENTITY_INF                 = 0x08,
    /// Identity Address Information
    L2C_CODE_ID_ADDR_INF                  = 0x09,
    /// Signing Information
    L2C_CODE_SIGNING_INF                  = 0x0A,
    /// Security Request
    L2C_CODE_SECURITY_REQ                 = 0x0B,
    /// Pairing Public Keys
...
/// Disconnection Response
/*@TRACE*/
struct l2cc_disconnection_resp
{
    /// Signaling code - 0x07
    uint8_t  code;
    /// Packet Identifier
...
/// Connection Parameter Update Request
/*@TRACE*/
struct l2cc_conn_param_upd_req
{
    /// Signaling code - 0x12
    uint8_t  code;
    /// Packet Identifier
...
/// Connection Parameter Update Response
/*@TRACE*/
struct l2cc_conn_param_upd_resp
{
    /// Signaling code - 0x13
    uint8_t  code;
    /// Packet Identifier
...
/// LE Flow Control Credit
/*@TRACE*/
struct l2cc_le_flow_control_credit
{
    /// Signaling code - 0x16
    uint8_t  code;
    /// Packet Identifier
...
/// Write Command
/*@TRACE
 * l2cc_att_wr_cmd_info = l2cc_att_wr_cmd
 */
...
/// Signed Write Command
/*@TRACE
 * l2cc_att_sign_wr_cmd_info = l2cc_att_sign_wr_cmd
 */
...
/*@TRACE
 @trc_ref l2cc_cid, l2cc_signaling_code, l2cc_attribute_code, l2cc_security_code
 */
union l2cc_pdu_data
{
    /// L2Cap packet code.
    ...
    /// LE send first frame
    //@trc_union parent.chan_id >= L2C_CID_DYN_MIN and parent.chan_id <= L2C_CID_DYN_MAX
    struct l2cc_lecb_send_data_req send_lecb_data_req;

    /* Connection Signaling Packets  */
    /// Command Reject
    //@trc_union code == L2C_CODE_REJECT and parent.chan_id == L2C_CID_LE_SIGNALING
    struct l2cc_reject           reject;
    /// Connection Parameter Update Request
    //@trc_union code == L2C_CODE_CONN_PARAM_UPD_REQ and parent.chan_id == L2C_CID_LE_SIGNALING
    struct l2cc_conn_param_upd_req update_req;
    /// Connection Parameter Update Response
    //@trc_union code == L2C_CODE_CONN_PARAM_UPD_RESP and parent.chan_id == L2C_CID_LE_SIGNALING
    struct l2cc_conn_param_upd_resp update_rsp;
    /// LE Credit based connection request
    //@trc_union code == L2C_CODE_LE_CB_CONN_REQ and parent.chan_id == L2C_CID_LE_SIGNALING
    struct l2cc_le_cb_conn_req credit_con_req;
    /// LE Credit based connection response
    //@trc_union code == L2C_CODE_LE_CB_CONN_RESP and parent.chan_id == L2C_CID_LE_SIGNALING
    struct l2cc_le_cb_conn_resp credit_con_rsp;
    /// LE Flow Control Credit
    //@trc_union code == L2C_CODE_LE_FLOW_CONTROL_CREDIT and parent.chan_id == L2C_CID_LE_SIGNALING
    struct l2cc_le_flow_control_credit flow_ctl_credit;
    /// LE disconnection request
    //@trc_union code == L2C_CODE_DISCONNECTION_REQ and parent.chan_id == L2C_CID_LE_SIGNALING
    struct l2cc_disconnection_req disc_req;
    /// LE disconnection response
    //@trc_union code == L2C_CODE_DISCONNECTION_RESP and parent.chan_id == L2C_CID_LE_SIGNALING
    struct l2cc_disconnection_resp disc_rsp;

    /* Security manager PDUs */
    /// Pairing Request
    //@trc_union code == L2C_CODE_PAIRING_REQ and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_pairing_req      pairing_req;
    /// Pairing Response
    //@trc_union code == L2C_CODE_PAIRING_RESP and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_pairing_resp      pairing_rsp;
    /// Pairing Confirm
    //@trc_union code == L2C_CODE_PAIRING_CFM and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_pairing_cfm      pairing_cfm;
    /// Pairing Random
    //@trc_union code == L2C_CODE_PAIRING_RANDOM and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_pairing_random   pairing_random;
    /// Pairing Failed
    //@trc_union code == L2C_CODE_PAIRING_FAILED and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_pairing_failed   pairing_failed;
    /// Encryption Information
    //@trc_union code == L2C_CODE_ENCRYPTION_INF and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_encryption_inf   encryption_inf;
    /// Master Identification
    //@trc_union code == L2C_CODE_MASTER_ID and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_master_id        master_id;
    /// Identity Information
    //@trc_union code == L2C_CODE_IDENTITY_INF and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_identity_inf     identity_inf;
    /// Identity Address Information
    //@trc_union code == L2C_CODE_ID_ADDR_INF and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_id_addr_inf      id_addr_inf;
    /// Signing Information
    //@trc_union code == L2C_CODE_SIGNING_INF and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_signing_inf      signing_inf;
    /// Security Request
    //@trc_union code == L2C_CODE_SECURITY_REQ and parent.chan_id == L2C_CID_SECURITY
   struct l2cc_security_req     security_req;
    /// Public Keys
   //@trc_union code == L2C_CODE_PUBLIC_KEY and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_public_key              public_key;
    /// Key Press Notification
    //@trc_union code == L2C_CODE_KEYPRESS_NOTIFICATION and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_keypress_notification  keypress_notification;
    /// DH Key Check
    //@trc_union code == L2C_CODE_DHKEY_CHECK and parent.chan_id == L2C_CID_SECURITY
    struct l2cc_dhkey_check               dhkey_check;

    /* Attribute protocol PDUs */
    /// Error response
    //@trc_union code == L2C_CODE_ATT_ERR_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_err_rsp             err_rsp;
    /// Exchange MTU Request
    //@trc_union code == L2C_CODE_ATT_MTU_REQ and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_mtu_req             mtu_req;
    /// Exchange MTU Response
    //@trc_union code == L2C_CODE_ATT_MTU_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_mtu_rsp             mtu_rsp;
    /// Find Information Request
    //@trc_union code == L2C_CODE_ATT_FIND_INFO_REQ and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_find_info_req       find_info_req;
    /// Find Information Response
    //@trc_union code == L2C_CODE_ATT_FIND_INFO_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_find_info_rsp       find_info_rsp;
    /// Find By Type Value Request
    //@trc_union code == L2C_CODE_ATT_FIND_BY_TYPE_REQ and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_find_by_type_req    find_by_type_req;
    /// Find By Type Value Response
    //@trc_union code == L2C_CODE_ATT_FIND_BY_TYPE_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_find_by_type_rsp    find_by_type_rsp;
    /// Read By Type Request
    //@trc_union code == L2C_CODE_ATT_RD_BY_TYPE_REQ and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_rd_by_type_req      rd_by_type_req;
    /// Read By Type Response
    //@trc_union code == L2C_CODE_ATT_RD_BY_TYPE_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_rd_by_type_rsp      rd_by_type_rsp;
    /// Read Request
    //@trc_union code == L2C_CODE_ATT_RD_REQ and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_rd_req              rd_req;
    /// Read Response
    //@trc_union code == L2C_CODE_ATT_RD_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_rd_rsp              rd_rsp;
    /// Read Blob Request
    //@trc_union code == L2C_CODE_ATT_RD_BLOB_REQ and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_rd_blob_req         rd_blob_req;
    /// Read Blob Response
    //@trc_union code == L2C_CODE_ATT_RD_BLOB_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_rd_blob_rsp         rd_blob_rsp;
    /// Read Multiple Request
    //@trc_union code == L2C_CODE_ATT_RD_MULT_REQ and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_rd_mult_req         rd_mult_req;
    /// Read Multiple Response
    //@trc_union code == L2C_CODE_ATT_RD_MULT_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_rd_mult_rsp         rd_mult_rsp;
    /// Read by Group Type Request
    //@trc_union code == L2C_CODE_ATT_RD_BY_GRP_TYPE_REQ and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_rd_by_grp_type_req  rd_by_grp_type_req;
    /// Read By Group Type Response
    //@trc_union code == L2C_CODE_ATT_RD_BY_GRP_TYPE_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_rd_by_grp_type_rsp  rd_by_grp_type_rsp;
    /// Write Request
    //@trc_union code == L2C_CODE_ATT_WR_REQ and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_wr_req              wr_req;
    /// Write Response
    //@trc_union code == L2C_CODE_ATT_WR_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_wr_rsp              wr_rsp;
    /// Write Command
    //@trc_union code == L2C_CODE_ATT_WR_CMD and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_wr_cmd              wr_cmd;
    /// Signed Write Command
    //@trc_union code == L2C_CODE_ATT_SIGN_WR_CMD and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_sign_wr_cmd         sign_wr_cmd;
    /// Prepare Write Request
    //@trc_union code == L2C_CODE_ATT_PREP_WR_REQ and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_prep_wr_req         prep_wr_req;
    /// Prepare Write Response
    //@trc_union code == L2C_CODE_ATT_PREP_WR_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_prep_wr_rsp         prep_wr_rsp;
    /// Execute Write Request
    //@trc_union code == L2C_CODE_ATT_EXE_WR_REQ and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_exe_wr_req          exe_wr_req;
    /// Execute Write Response
    //@trc_union code == L2C_CODE_ATT_EXE_WR_RSP and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_exe_wr_rsp          exe_wr_rsp;
    /// Handle Value Notification
    //@trc_union code == L2C_CODE_ATT_HDL_VAL_NTF and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_hdl_val_ntf         hdl_val_ntf;
    /// Handle Value Indication
    //@trc_union code == L2C_CODE_ATT_HDL_VAL_IND and parent.chan_id == L2C_CID_ATTRIBUTE
    struct l2cc_att_hdl_val_ind         hdl_val_ind;
    /// Handle Value Confirmation
    //@trc_union code == L2C_CODE_ATT_HDL_VAL_CFM and parent.chan_id == L2C_CID_ATTRIBUTE
