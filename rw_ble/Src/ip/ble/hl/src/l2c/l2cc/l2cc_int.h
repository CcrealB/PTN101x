 ...
 ****************************************************************************************
 */
void l2cc_init(uint8_t init_type);
...
/**
 * @brief Complete the operation by cleanning-up variable used and end a complete event to operation requester.
 *
 * @param[in] conidx        Connection index
 ...
 * @param[in] credit    number of used credit (0 on signaling channel)
 ****************************************************************************************
 */
