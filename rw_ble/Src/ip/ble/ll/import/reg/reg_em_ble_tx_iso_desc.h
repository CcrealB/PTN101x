 ...
 * </pre>
 */
#define EM_BLE_TXISOPTR_ADDR   (0x01110000 + EM_BLE_TX_ISO_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXISOCNT0_ADDR   (0x01110002 + EM_BLE_TX_ISO_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXISOCNT1_ADDR   (0x01110004 + EM_BLE_TX_ISO_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXISOCNT2_ADDR   (0x01110006 + EM_BLE_TX_ISO_DESC_OFFSET)
...
__INLINE void em_ble_txisocnt2_pack(int elt_idx, uint8_t txflushinstant, uint8_t txisocnt2)
{
    ...
    ASSERT_ERR((((uint16_t)txisocnt2 << 0) & ~((uint16_t)0x0000007F)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_TXISOPHM0_ADDR   (0x01110008 + EM_BLE_TX_ISO_DESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXISOBUFPTR_ADDR   (0x0111000A + EM_BLE_TX_ISO_DESC_OFFSET)
