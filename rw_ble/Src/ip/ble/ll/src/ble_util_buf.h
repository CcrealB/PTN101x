...
#if 0 //20200729 for passive scan bug check and fix solution
	uint8_t  used;
#endif
}__attribute__((packed));
...
****************************************************************
*
* 20200727 add for data buffer utillity
****************************************************************
*/
void ble_util_buf_rx_pool_info(void);
void ble_util_refresh_rx_used_cnt(void);
void ble_util_all_rx_desc_data_buf_alloc(void);
uint8_t  ble_util_buf_rx_used(void);
uint16_t get_rx_pool_min_bufptr(void);
uint16_t get_rx_pool_max_bufptr(void);
uint8_t databufptr_valid(uint16_t databufptr);
#endif
void ble_util_dump_ble_rx_desc_info(void);
