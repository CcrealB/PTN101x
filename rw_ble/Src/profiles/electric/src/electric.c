...
{
    // Service Declaration
    [ELECTRIC_IDX_SVC]      =   {{L_UINT16( ATT_DECL_PRIMARY_SERVICE ), H_UINT16( ATT_DECL_PRIMARY_SERVICE )}, PERM(RD, ENABLE), 0, 0},

    // RX Characteristic Declaration
    [ELECTRIC_IDX_RX_CHAR]  =   {{L_UINT16( ATT_DECL_CHARACTERISTIC ), H_UINT16( ATT_DECL_CHARACTERISTIC )}, PERM(RD, ENABLE), 0, 0},    
    ...
    [ELECTRIC_IDX_TX_CHAR]  =   {{L_UINT16( ATT_DECL_CHARACTERISTIC ), H_UINT16( ATT_DECL_CHARACTERISTIC )}, PERM(RD, ENABLE), 0, 0},
    ...
    [ELECTRIC_IDX_TX_NTF_CFG] = {{L_UINT16( ATT_DESC_CLIENT_CHAR_CFG ), H_UINT16( ATT_DESC_CLIENT_CHAR_CFG )}, PERM(RD, ENABLE)|PERM(NTF, ENABLE)| PERM(WRITE_REQ, ENABLE), 0, 0},
