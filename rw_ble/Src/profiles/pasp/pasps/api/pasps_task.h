...
{
    /// Set Bonded Data
    PASPS_ENABLE_REQ = TASK_FIRST_MSG(TASK_ID_PASPS),//!< PASPS_ENABLE_REQ
    /// Bonded data confirmation
    PASPS_ENABLE_RSP,                                //!< PASPS_ENABLE_RSP

    /// Update the value of a characteristic
    PASPS_UPDATE_CHAR_VAL_CMD,                       //!< PASPS_UPDATE_CHAR_VAL_CMD
    /// Indicate that an attribute value has been written
    PASPS_WRITTEN_CHAR_VAL_IND,                      //!< PASPS_WRITTEN_CHAR_VAL_IND

    /// Complete Event Information
    PASPS_CMP_EVT,                                   //!< PASPS_CMP_EVT
};
