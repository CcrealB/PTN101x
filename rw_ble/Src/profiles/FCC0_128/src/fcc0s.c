...
const struct attm_desc_128 fcc0_att_db[FCC0S_IDX_NB] =
{
    ...
    [FCC0S_IDX_SVC]            =   {{L_UINT16( ATT_DECL_PRIMARY_SERVICE ), H_UINT16( ATT_DECL_PRIMARY_SERVICE )}, PERM(RD, ENABLE), 0, 0},

	[FCC0S_IDX_FCC1_VAL_CHAR]  =   {{L_UINT16( ATT_DECL_CHARACTERISTIC ), H_UINT16( ATT_DECL_CHARACTERISTIC )}, PERM(RD, ENABLE), 0, 0}, 
	...
	[FCC0S_IDX_FCC2_VAL_CHAR]  =   {{L_UINT16( ATT_DECL_CHARACTERISTIC ), H_UINT16( ATT_DECL_CHARACTERISTIC)}, PERM(RD, ENABLE), 0, 0},
	...
	[FCC0S_IDX_FCC2_VAL_NTF_CFG] = {{L_UINT16( ATT_DESC_CLIENT_CHAR_CFG ), H_UINT16( ATT_DESC_CLIENT_CHAR_CFG)},  PERM(RD, ENABLE)|PERM(WRITE_REQ, ENABLE), 0, 0},
