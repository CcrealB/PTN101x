...
enum cpps_msg_id
{
    ...
    CPPS_ENABLE_REQ = TASK_FIRST_MSG(TASK_ID_CPPS),//!< CPPS_ENABLE_REQ
    /// Confirm profile
    CPPS_ENABLE_RSP,                               //!< CPPS_ENABLE_RSP

    /// Gets packed data for advertising
    CPPS_GET_ADV_DATA_REQ,                         //!< CPPS_GET_ADV_DATA_REQ
    /// Response with packed data for advertising
    CPPS_GET_ADV_DATA_RSP,                         //!< CPPS_GET_ADV_DATA_RSP

    /// Send a CP Measurement to the peer device (Notification)
    CPPS_NTF_CP_MEAS_REQ,                          //!< CPPS_NTF_CP_MEAS_REQ
    /// CP Measurement response
    CPPS_NTF_CP_MEAS_RSP,                          //!< CPPS_NTF_CP_MEAS_RSP

    /// Send a CP Vector to the peer device (Notification)
    CPPS_NTF_CP_VECTOR_REQ,                        //!< CPPS_NTF_CP_VECTOR_REQ
    /// CP Vector response
    CPPS_NTF_CP_VECTOR_RSP,                        //!< CPPS_NTF_CP_VECTOR_RSP

    /// Send a complete event status to the application
    CPPS_CMP_EVT,                                  //!< CPPS_CMP_EVT

    /// Indicate that an attribute value has been written
    CPPS_CFG_NTFIND_IND,                           //!< CPPS_CFG_NTFIND_IND

    /// Request to change vector client configuration
    CPPS_VECTOR_CFG_REQ_IND,                       //!< CPPS_VECTOR_CFG_REQ_IND
    /// Confirmation to change vector client configuration
    CPPS_VECTOR_CFG_CFM,                           //!< CPPS_VECTOR_CFG_CFM

    /// Indicate that Control Point characteristic value has been written
    CPPS_CTNL_PT_REQ_IND,                          //!< CPPS_CTNL_PT_REQ_IND
    /// Application response after receiving a CPPS_CTNL_PT_REQ_IND message
    CPPS_CTNL_PT_CFM,                              //!< CPPS_CTNL_PT_CFM
};
