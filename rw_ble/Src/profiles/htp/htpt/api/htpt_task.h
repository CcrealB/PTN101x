...
enum htpt_msg_id
{
    ...
    HTPT_ENABLE_REQ = TASK_FIRST_MSG(TASK_ID_HTPT),//!< HTPT_ENABLE_REQ
    /// Enable confirmation
    HTPT_ENABLE_RSP,                               //!< HTPT_ENABLE_RSP

    /// Send temperature value from APP
    HTPT_TEMP_SEND_REQ,                            //!< HTPT_TEMP_SEND_REQ
    /// Send temperature response
    HTPT_TEMP_SEND_RSP,                            //!< HTPT_TEMP_SEND_RSP

    /// Indicate Measurement Interval
    HTPT_MEAS_INTV_UPD_REQ,                        //!< HTPT_MEAS_INTV_UPD_REQ
    /// Send Measurement Interval response
    HTPT_MEAS_INTV_UPD_RSP,                        //!< HTPT_MEAS_INTV_UPD_RSP

    /// Inform APP of new measurement interval value requested by a peer device
    HTPT_MEAS_INTV_CHG_REQ_IND,                    //!< HTPT_MEAS_INTV_CHG_REQ_IND
    ...
    HTPT_MEAS_INTV_CHG_CFM,                        //!< HTPT_MEAS_INTV_CHG_CFM

    /// Inform APP that Indication Configuration has been changed - use to update bond data
    HTPT_CFG_INDNTF_IND,                           //!< HTPT_CFG_INDNTF_IND
};
