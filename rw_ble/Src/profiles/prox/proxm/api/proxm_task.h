...
enum proxm_msg_id
{
    ...
    PROXM_ENABLE_REQ = TASK_FIRST_MSG(TASK_ID_PROXM),//!< PROXM_ENABLE_REQ
    /// Proximity Monitor role enable confirmation to application.
    PROXM_ENABLE_RSP,                                //!< PROXM_ENABLE_RSP

    /// Read LLS Alert or TX Power Level - request
    PROXM_RD_REQ,                                    //!< PROXM_RD_REQ
    /// Read LLS Alert or TX Power Level - response
    PROXM_RD_RSP,                                    //!< PROXM_RD_RSP

    ///Set Alert level
    PROXM_WR_ALERT_LVL_REQ,                          //!< PROXM_WR_ALERT_LVL_REQ
    ///Set Alert level response
    PROXM_WR_ALERT_LVL_RSP,                          //!< PROXM_WR_ALERT_LVL_RSP
};
