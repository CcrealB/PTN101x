...
enum rscps_msg_id
{
    ...
    RSCPS_ENABLE_REQ = TASK_FIRST_MSG(TASK_ID_RSCPS),//!< RSCPS_ENABLE_REQ
    /// Enable the RSCP Sensor task for a connection
    RSCPS_ENABLE_RSP,                                //!< RSCPS_ENABLE_RSP

    /// Send a RSC Measurement to the peer device (Notification)
    RSCPS_NTF_RSC_MEAS_REQ,                          //!< RSCPS_NTF_RSC_MEAS_REQ
    /// Response of RSC Measurement send request
    RSCPS_NTF_RSC_MEAS_RSP,                          //!< RSCPS_NTF_RSC_MEAS_RSP

    /// Indicate that the SC Control Point characteristic value has been written
    RSCPS_SC_CTNL_PT_REQ_IND,                        //!< RSCPS_SC_CTNL_PT_REQ_IND
    /// Application response after receiving a RSCPS_SC_CTNL_PT_REQ_IND message
    RSCPS_SC_CTNL_PT_CFM,                            //!< RSCPS_SC_CTNL_PT_CFM

    /// Indicate a new NTF/IND configuration to the application
    RSCPS_CFG_NTFIND_IND,                            //!< RSCPS_CFG_NTFIND_IND

    /// Send a complete event status to the application
    RSCPS_CMP_EVT,                                   //!< RSCPS_CMP_EVT
};
