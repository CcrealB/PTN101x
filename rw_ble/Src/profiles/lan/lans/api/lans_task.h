...
enum lans_msg_id
{
    ...
    LANS_ENABLE_REQ = TASK_FIRST_MSG(TASK_ID_LANS),//!< LANS_ENABLE_REQ
    /// Confirm profile
    LANS_ENABLE_RSP,                               //!< LANS_ENABLE_RSP

    /// Update Position Quality
    LANS_UPD_POS_Q_REQ,                            //!< LANS_UPD_POS_Q_REQ
    /// Update Position Quality
    LANS_UPD_POS_Q_RSP,                            //!< LANS_UPD_POS_Q_RSP

    /// Send a Location and Speed to the peer device (Notification)
    LANS_NTF_LOC_SPEED_REQ,                        //!< LANS_NTF_LOC_SPEED_REQ
    /// Response of Send a Location and Speed request
    LANS_NTF_LOC_SPEED_RSP,                        //!< LANS_NTF_LOC_SPEED_RSP

    /// Send a LN Vector to the peer device (Notification)
    LANS_NTF_NAVIGATION_REQ,                       //!< LANS_NTF_NAVIGATION_REQ
    /// Response of Send LN Vector request
    LANS_NTF_NAVIGATION_RSP,                       //!< LANS_NTF_NAVIGATION_RSP

    /// Send a complete event status to the application
    LANS_CMP_EVT,                                  //!< LANS_CMP_EVT

    /// Indicate that an attribute value has been written
    LANS_CFG_NTFIND_IND,                           //!< LANS_CFG_NTFIND_IND

    /// Indicate that Control Point characteristic value has been written
    LANS_LN_CTNL_PT_REQ_IND,                       //!< LANS_LN_CTNL_PT_REQ_IND
    /// Application response after receiving a LANS_CTNL_PT_REQ_IND message
    LANS_LN_CTNL_PT_CFM,                           //!< LANS_LN_CTNL_PT_CFM
};
