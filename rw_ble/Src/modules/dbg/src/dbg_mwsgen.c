...
uint8_t dbg_mwscoex_scen_set(uint32_t scenario)
{
    ...
    case 0x01000000:
        ...
        dbg_mwsgen_config(10000 /*mws_period*/, 6250 /*mws_duty_cycle*/, 4000 /*rx_act*/, 3000 /*tx_act*/);
        mwsgen_mws_scan_frequency_setf((scenario >> 16) & 0xF);
        mws_config_word = true;
        break;
    case 0x02000000:
        // fixed configuration set #2
        dbg_mwsgen_config(20000 /*mws_period*/, 8000 /*mws_duty_cycle*/, 2000 /*rx_act*/, 1000 /*tx_act*/);
        mwsgen_mws_scan_frequency_setf((scenario >> 16) & 0xF);
        mws_config_word = true;
        break;
    case 0x03000000:
...
void dbg_mwsgen_config(uint32_t period, uint32_t duty_cycle, uint32_t rx_act, uint32_t tx_act)
{
